...
describe("#sortedFrequency", function(){
  it("returns the frequency", function(){
    ...
    expect(sortedFrequency([1, 1, 1, 2, 2, 2], 2)).toBe(3)
    expect(sortedFrequency([1, 1, 1, 2, 2, 2], 1)).toBe(3)
    expect(sortedFrequency([2, 2, 2, 2, 2, 2], 2)).toBe(6)
    expect(sortedFrequency([2, 2, 2, 2, 2, 2], 1)).toBe(-1)
  })
})
